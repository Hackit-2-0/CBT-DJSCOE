...
# load the model
    ...
    def train(self):
        ...
        inputsData = tflearn.input_data(
            shape=[None, len(self.training[0])])
        ...
        try:
            self.data = self.model.load('dataflowModel.tflearn.index')
            print(self.data)

        except:
            self.model.fit(self.training, self.output, n_epoch=200,
